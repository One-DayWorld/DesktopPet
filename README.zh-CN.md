...
<!-- ⚠️ 在这里放一段演示 GIF —— 对一个"视觉系"项目, 这是涨 star 的头号杠杆。
     录 ~8 秒: VF-1 沿屏幕边沿巡航 → 变形 → Claude 弹授权时机体闪金光。
     存成 docs/demo.gif 后取消下面这行注释。 -->
<!-- ![VF-1 在桌面巡航](docs/demo.gif) -->
...
- 🧠 **自带大脑** —— 机体只是躯壳,智能来自你接入的 **千问 / DeepSeek / 豆包 / 本地 Ollama**,还可选联网搜索。
...
<!-- 换成真实录屏 —— 哪怕只有一段好 GIF, 也会显著提升 star 转化率。 -->
| 边沿巡航 & 变形 | Claude Code 告警 | 座舱面板 |
|---|---|---|
...
| **豆包** | `doubao-1-5-pro-32k` | 火山方舟 | [console.volcengine.com/ark](https://console.volcengine.com/ark) |
| **Ollama** | `llama3`(本地) | localhost:11434 | 无需,本地运行 |
